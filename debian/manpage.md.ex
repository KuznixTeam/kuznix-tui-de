% kuznix-tui-de(SECTION) | User Commands
%
% "September 21 2025"
...
kuznix-tui-de - program to do something

# SYNOPSIS

**kuznix-tui-de** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**kuznix-tui-de** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **kuznix-tui-de** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**kuznix-tui-de** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    kuznix-tui-de. See **foo.conf**(5) for further details.
...
**kuznix-tui-de** provides some return codes, that can be used in scripts:
...
Krzysztof Demir Kuźniak <kuznix@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Krzysztof Demir Kuźniak
